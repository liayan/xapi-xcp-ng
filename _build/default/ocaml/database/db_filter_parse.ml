...
open Parsing;;
let _ = parse_error;;
# 3 "ocaml/database/db_filter_parse.mly"
 open Db_filter_types;;
# 19 "ocaml/database/db_filter_parse.ml"
let yytransl_const = [|
  257 (* EQ *);
  258 (* TRUE *);
  259 (* FALSE *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 30 "ocaml/database/db_filter_parse.mly"
        ( Literal _1 )
# 163 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types._val))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 31 "ocaml/database/db_filter_parse.mly"
              ( Field _2 )
# 170 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types._val))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 34 "ocaml/database/db_filter_parse.mly"
                 ( Eq(_1,_3) )
# 178 "ocaml/database/db_filter_parse.ml"
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 35 "ocaml/database/db_filter_parse.mly"
                 ( And(_1,_3) )
# 186 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types.expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Db_filter_types.expr) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : Db_filter_types.expr) in
    Obj.repr(
# 36 "ocaml/database/db_filter_parse.mly"
                ( Or(_1,_3) )
# 194 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types.expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : Db_filter_types.expr) in
    Obj.repr(
# 37 "ocaml/database/db_filter_parse.mly"
            ( Not(_2) )
# 201 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types.expr))
; (fun __caml_parser_env ->
    Obj.repr(
# 38 "ocaml/database/db_filter_parse.mly"
       ( True )
# 207 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types.expr))
; (fun __caml_parser_env ->
    Obj.repr(
# 39 "ocaml/database/db_filter_parse.mly"
        ( False )
# 213 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types.expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : Db_filter_types.expr) in
    Obj.repr(
# 40 "ocaml/database/db_filter_parse.mly"
                     ( _2 )
# 220 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types.expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : Db_filter_types.expr) in
    Obj.repr(
# 43 "ocaml/database/db_filter_parse.mly"
           ( _1 )
# 227 "ocaml/database/db_filter_parse.ml"
               : Db_filter_types.expr))
(* Entry exprstr *)
